# ------------------------------------------------------------------------------------
# This is modified from https://github.com/openai/CLIP/blob/main/clip/simple_tokenizer.py
...
class SimpleTokenizer(object):
    ...
    def padded_tokens_and_mask(self, texts, text_ctx):
        ...
        if packaging.version.parse(torch.__version__) < packaging.version.parse(
            ...
            result = torch.zeros(len(all_tokens), text_ctx, dtype=torch.long)
        else:
...
def get_clip_tokenizer():
    return SimpleTokenizer(bpe_path=default_bpe())
